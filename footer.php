			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    <div class='container'>
                        ...
                        <span class='copyright'><?php echo $copyright ?>. Site by <a href="http://greyship.com">Grey Ship</a></span>
...
var customPath = "/nationalsawdust/wp-content/themes/omw/fonts";
</script>
<script type="text/javascript" src="/nationalsawdust/wp-content/themes/omw/fonts/fonts.js"></script>
